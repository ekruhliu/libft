...
SRC = ./srcs/ft_isalpha.c ./srcs/ft_memchr.c ./srcs/ft_strcat.c ./srcs/ft_strlcat.c ./srcs/ft_strnstr.c \
		...
		./srcs/ft_putendl_fd.c ./srcs/ft_putnbr_fd.c ./srcs/ft_super_array.c ./srcs/ft_lstnew.c ./srcs/ft_lstdelone.c \
...
OBJ = ft_isalpha.o ft_memchr.o ft_strcat.o ft_strlcat.o ft_strnstr.o \
		...
		ft_putendl_fd.o ft_putnbr_fd.o ft_super_array.o ft_lstnew.o ft_lstdelone.o \
